...
open class BeaconScanPermissionsActivity: PermissionsActivity()  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val title = intent.getStringExtra("title") ?: "Permisos"
        val message = intent.getStringExtra("message") ?: "Presiona cada botón para dar permisos a la aplicación "
    ...
    fun promptForPermissions(permissionsGroup: Array<String>) {
        if (!allPermissionsGranted(permissionsGroup)) {
            ...
            if (showRationale ||  PermissionsHelper(this).isFirstTimeAskingPermission(firstPermission)) {
                ...
                builder.setTitle("No se obtuvieron permisos")
                builder.setMessage("Anteriormente los permisos fueron denegados, tienes que ir a configuraciones buscar la app y permitir permisos.")
